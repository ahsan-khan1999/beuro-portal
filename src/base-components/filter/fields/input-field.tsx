...
export default function InputField({ label, title, border, value, handleChange }: InputFieldProps) {
    return (
        <div className="w-[274px] ">
            ...
            <div className="relative w-full ">
                <input
                    ...
                    defaultValue={value}
                    placeholder="Search..."
                    className="bg-white w-full  text-sm   rounded-md  pr-8 pl-3 py-2 focus:outline-none placeholder:text-[#222B45] text-[#222B45] text-[13px]"
