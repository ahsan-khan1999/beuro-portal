...
export default function InputField({ value, handleChange, textClassName, containerClassName, iconDisplay }: InputFieldProps) {
    const inputClasses = combineClasses("bg-white w-full  text-sm   rounded-md  pr-8 pl-3 py-2 focus:outline-none placeholder:text-[#222B45] text-[#222B45] text-[13px]", textClassName)
