      ...
      <div>
        ...
        <div className=" mt-2">
          <input
            ...
            type="number"
            value={lowPrice}
            className="bg-gray-50 border border-lightDark text-lightDark text-sm rounded-lg focus:outline-primary focus:outline block w-[170px] px-5 py-[14px] h-[42px] placeholder:text-lightDark"
            placeholder="0"
            onChange={(e) =>
