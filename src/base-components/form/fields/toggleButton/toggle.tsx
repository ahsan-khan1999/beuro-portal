...
export const ToggleButton = ({
  ...
  const combineClass = combineClasses(
    `relative h-[15px] w-[26px] px-[2px] flex-shrink-0 appearance-none rounded-full ${disabledClass}
    after:absolute after:z-[2] after:h-[10px] after:w-[10px] after:rounded-full after:border-none after:bg-white after:mt-[2px]
