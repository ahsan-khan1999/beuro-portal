...
export const generateAddPostPonedValidation = (translate: Function) => {
  return yup.object().shape({
    [AddPostPonedNote.date]: yup
      .string()
      .required(translate("validationMessages.required")),
    [AddPostPonedNote.detail]: yup
      .string()
      .required(translate("validationMessages.required")),
  });
};
...
export const generateAddFollowUpValidation = (translate: Function) => {
  return yup.object().shape({
    [AddFollowUp.selectCustomer]: yup
      .string()
      .required(translate("validationMessages.required")),
    [AddFollowUp.title]: yup
      .string()
      .required(translate("validationMessages.required")),
    [AddFollowUp.selectLead]: yup
      .string()
      .required(translate("validationMessages.required")),
    [AddFollowUp.dateAndTime]: yup
      .string()
      .required(translate("validationMessages.required")),
    [AddFollowUp.followUpType]: yup
      .string()
      .required(translate("validationMessages.required")),
    [AddFollowUp.addititionalDetails]: yup.string().notRequired(),
    // .required(translate("validationMessages.required")),
  });
};
