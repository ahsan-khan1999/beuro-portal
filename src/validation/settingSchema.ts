  ...
  return yup.object().shape({
    ...
    "company": yup.object().shape({
      ...
      "address": yup.object().shape({
        ...
        [SettingProfile.postCode]: yup.number().required(translate("validationMessages.required")),
        [SettingProfile.country]: yup.string().required(translate("validationMessages.required")),
      }),
      "bankDetails": yup.object().shape({
        ...
        [SettingProfile.accountNumber]: yup
          .number()
          .required(translate("validationMessages.required")),
        [SettingProfile.IBAN_number]: yup.number().required(translate("validationMessages.required")),
      })
    }),
  });
};
