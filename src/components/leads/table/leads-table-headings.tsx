      ...
      {isAgent ? (
        <div className="mlg:hidden">
          ...
          >
            ...
            <span className="font-semibold text-base text-white">
              {translate("leads.table_headings.appointment")}
            </span>
          </div>
        </div>
      ) : null}
