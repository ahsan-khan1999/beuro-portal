      ...
      {dataToAdd?.map((item: Lead, index: number) => {
        return (
          <div
            ...
            key={index}
            className="cursor-pointer items-center hover:bg-[#E9E1FF] gap-x-4 xs:w-fit mlg:w-full grid xs:grid-cols-[minmax(80px,_80px),minmax(400px,4fr)_minmax(300px,_3fr)_minmax(150px,150px)_minmax(130px,_130px)_minmax(120px,_120px)_minmax(170px,_170px)_minmax(70px,_70px)_minmax(70px,_70px)_minmax(50px,_50px)] mlg:grid-cols-[minmax(50px,_50px)_minmax(50px,_4fr)_minmax(130px,_130px)_minmax(190px,_190px)_minmax(60px,_60px)_minmax(60px,_60px)_minmax(50px,_50px)] xlg:grid-cols-[minmax(50px,_50px)_minmax(80px,_4fr)_minmax(130px,_130px)_minmax(190px,_190px)_minmax(60px,_60px)_minmax(60px,_60px)_minmax(50px,_50px)] maxSize:grid-cols-[minmax(50px,_50px)_minmax(100px,_100%)_minmax(130px,_130px)_minmax(130px,_130px)_minmax(190px,_190px)_minmax(60px,_60px)_minmax(60px,_60px)_minmax(50px,_50px)] xMaxSize:grid-cols-[minmax(50px,_50px)_minmax(100px,_100%)_minmax(110px,_110px)_minmax(140px,_140px)_minmax(100px,_100px)_minmax(190px,_190px)_minmax(60px,_60px)_minmax(60px,_60px)_minmax(50px,_50px)] xLarge:grid-cols-[minmax(70px,_70px),minmax(70px,4fr)_minmax(70px,_3fr)_minmax(120px,_120px)_minmax(120px,_120px)_minmax(100px,_100px)_minmax(190px,_190px)_minmax(60px,_60px)_minmax(60px,_60px)_minmax(50px,_50px)] border-t border-t-[#E7EAEE]"
          >
