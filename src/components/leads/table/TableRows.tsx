      ...
      {dataToAdd?.map((item: Lead, index: number) => {
        return (
          ...
          >
            ...
            <span
              className="px-6 py-4 flex justify-center items-center  cursor-pointer"
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M20.0838 15.9531C20.0838 15.6117 19.8071 15.335 19.4657 15.335H13.0991C12.7577 15.335 12.481 15.6117 12.481 15.9531C12.481 16.2945 12.7577 16.5712 13.0991 16.5712H19.4657C19.8071 16.5712 20.0838 16.2945 20.0838 15.9531Z"
                  fill="#4A13E7"
                />
                <path
                  d="M13.0991 17.8076C12.7577 17.8076 12.481 18.0843 12.481 18.4257C12.481 18.7671 12.7577 19.0438 13.0991 19.0438H16.9657C17.3071 19.0438 17.5838 18.7671 17.5838 18.4257C17.5838 18.0843 17.3071 17.8076 16.9657 17.8076H13.0991Z"
                  fill="#4A13E7"
                />
                <path
                  d="M14.5505 23.7418H12.4832C11.8015 23.7418 11.247 23.1873 11.247 22.5056V11.6268C11.247 10.9451 11.8015 10.3905 12.4832 10.3905H20.0826C20.7643 10.3905 21.3188 10.9451 21.3188 11.6268V15.4282C21.3188 15.7696 21.5956 16.0463 21.937 16.0463C22.2783 16.0463 22.5551 15.7696 22.5551 15.4282V11.6268C22.5551 10.2634 21.4459 9.1543 20.0826 9.1543H12.4832C11.1199 9.1543 10.0107 10.2634 10.0107 11.6268V22.5056C10.0107 23.8689 11.1199 24.9781 12.4832 24.9781H14.5505C14.8919 24.9781 15.1686 24.7013 15.1686 24.36C15.1686 24.0186 14.8919 23.7418 14.5505 23.7418Z"
                  fill="#4A13E7"
                />
                <path
                  d="M19.4657 12.8633H13.0991C12.7577 12.8633 12.481 13.14 12.481 13.4814C12.481 13.8228 12.7577 14.0995 13.0991 14.0995H19.4657C19.8071 14.0995 20.0838 13.8228 20.0838 13.4814C20.0838 13.14 19.8071 12.8633 19.4657 12.8633Z"
                  fill="#4A13E7"
                />
              </svg>
            </span>
            ...
            <span
              className="px-6 py-4 flex justify-center items-center rounded-md"
              onClick={() =>
                router.push({
                  pathname: "/leads/details",
                  query: { lead: item?.id },
            ...
            >
              <Image src={moreInfo} alt="more info" />
            </span>
          </div>
        );
      })}
