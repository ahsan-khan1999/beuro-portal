              ...
              <>
                <div className="mlg:hidden">
                  <div
                    ...
                    } pl-4 pr-1 cursor-pointer rounded-md items-center hover:bg-[#E9E1FF] gap-x-1 grid xs:grid-cols-[minmax(65px,_65px)_minmax(80px,100%)_minmax(100px,100%)_minmax(140px,_140px)] xAir:grid-cols-[minmax(65px,_65px)_minmax(80px,100%)_minmax(100px,100%)_minmax(140px,_140px)] border-t border-t-[#E7EAEE]`}
                  >
