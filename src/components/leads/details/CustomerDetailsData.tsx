...
const CustomerDetailsData = ({onClick}: {onClick: (index: number, component: ComponentsType) => void;}) => {
  const router = useRouter();

  return (
    <LeadsCardLayout>
      <div className="flex justify-between items-center pb-5 border-b border-black border-opacity-20" id="0">
        <h2 className="text-[#393939] text-lg font-medium">Customer Details</h2>
        <button
          onClick={() => onClick(ComponentsType.customer, ComponentsType.customerEdit)}
