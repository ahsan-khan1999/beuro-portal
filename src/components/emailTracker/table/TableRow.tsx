        ...
        return (
          ...
          >
            ...
            <span className="py-4 flex justify-center items-center">
              <div
                className={`${
                  item?.mailStatus === "failed" && "bg-[#FF376F]"
                } bg-[${
            ...
            <span className="py-4 flex justify-center items-center">
              <span className="p-1 border border-[#f4f4f4]">
                <svg
