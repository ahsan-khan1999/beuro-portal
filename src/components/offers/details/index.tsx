...
const OfferDetails = () => {
  ...
  return (
    <Layout>
      ...
      <div className="bg-white rounded-md px-5 pt-5 pb-10 2xl:fixed offerCardCalWidth z-10 2xl:-mt-[354px] 2xl:border-t-[14px] 2xl:border-t-defaultBackground">
        <OfferDetailsCard
      ...
      <div className="2xl:mt-[435px] w-full 2xl:block">
        {isSendEmail ? (
          <div className="mt-5">
            <ComposeMail
