...
const EditOffersDetailsData = ({
  ...
  const componentsLookUp = {
    ...
    [EditComponentsType.addressEdit]: (
      <AddressEditDetails handleNext={handleNextTab} />
    ),
    [EditComponentsType.serviceEdit]: (
      <ServiceEditDetails handleNext={handleNextTab} />
    ),
    [EditComponentsType.additionalEdit]: (
