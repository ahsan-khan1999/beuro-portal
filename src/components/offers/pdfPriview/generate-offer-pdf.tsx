...
const OfferPdfDownload = ({ offerData, offerPdfFile, setOfferPdfFile }: { offerData?: PdfProps<EmailHeaderProps>, offerPdfFile: any, setOfferPdfFile?: SetStateAction<any> }) => {
        ...
        <div className="download-link">
            <BlobProvider
                ...
                {({ blob, url, loading, error }) => {
                    if (blob && !offerPdfFile) {
                        setOfferPdfFile(blobToFile(blob, "offer.pdf"));
                    }
                    return (
                        <>
                        </>)
