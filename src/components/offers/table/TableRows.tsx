      ...
      {dataToAdd?.map((item, index) => {
        return (
          ...
          >
            ...
            <span className="py-4 mlg:hidden xlg:hidden maxSize:block truncate">
