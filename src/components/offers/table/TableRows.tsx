      ...
      {dataToAdd?.map((item, index) => {
        return (
          ...
          >
            ...
            <span className="break-all hidden py-4 xs:flex mlg:hidden xlg:hidden maxSize:hidden xMaxSize:flex items-center">
              {item?.title}
            </span>
