          ...
          <div className="flex" key={index}>
            <div className="mlg:w-full">
              ...
              >
                ...
                <span className="py-4 truncate">Umzug Fuchs</span>
            ...
            <div className="grid grid-cols-[minmax(140px,_140px)] gap-x-3">
