...
const TableHeading = () => {
  ...
  return (
    <div className="grid xs:w-fit xlg:w-auto mlg:w-full xs:grid-cols-[minmax(50px,_50px),minmax(150px,_150px)_minmax(300px,_100%)_minmax(130px,_130px)_minmax(120px,_120px)_minmax(110px,_110px)_minmax(100px,_100px)_minmax(90px,_90px)] mlg:grid-cols-[minmax(60px,_60px),minmax(90px,_90px)_minmax(110px,_100%)_minmax(110px,_110px)_minmax(100px,_100px)_minmax(90px,_90px)_minmax(80px,_80px)] xlg:grid-cols-[minmax(50px,_50px),minmax(90px,_90px)_minmax(150px,_100%)_minmax(110px,_110px)_minmax(100px,_100px)_minmax(90px,_90px)_minmax(90px,_90px)_minmax(80px,_80px)] maxSize:grid-cols-[minmax(50px,_50px),minmax(100px,_100px)_minmax(140px,_100%)_minmax(130px,_130px)_minmax(100px,_100px)_minmax(110px,_110px)_minmax(100px,_100px)_minmax(80px,_80px)] xMaxSize:grid-cols-[minmax(50px,_50px),minmax(150px,_150px)_minmax(180px,_100%)_minmax(140px,_100%)_minmax(130px,_130px)_minmax(120px,_120px)_minmax(100px,_100px)_minmax(80px,_80px)] bg-white rounded-md gap-x-4 px-6 pt-[23px] pb-[17px]">
