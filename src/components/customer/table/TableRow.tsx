      ...
      {currentPageRows?.map((item, index) => {
        return (
          <div
            ...
            key={index}
            className="hover:bg-[#E9E1FF] cursor-pointer px-6 shadow-tableRow  gap-x-4 xs:w-fit mlg:w-full xs:grid-cols-[minmax(60px,_70px),minmax(213px,_213px)_minmax(213px,_213px)_minmax(213px,_213px)_minmax(120px,_120px)_minmax(100px,_100px)_minmax(50px,_50px)] mlg:grid-cols-[minmax(50px,_50px),minmax(120px,_120px)_minmax(160px,_100%)_minmax(130px,_130px)_minmax(100px,_100px)_minmax(70px,_70px)_minmax(40px,_40px)] grid xlg:grid-cols-[minmax(40px,_70px),minmax(150px,_100%)_minmax(180px,_100%)_minmax(120px,_100%)_minmax(100px,_100%)_minmax(60px,_150px)_minmax(40px,_40px)]  mt-2 bg-white rounded-md"
          >
