...
const CustomerForm = ({ isUpdate, setIsUpdate, fields, onSubmit, handleSubmit, errors }: FormDataProps) => {
  ...
  return (
    <FormCard>
      <div className="flex justify-between items-center pb-5 border-b border-black border-opacity-20">
        ...
        {
          isUpdate ?
            <BaseButton buttonText="Edit Details" onClick={() => setIsUpdate(!isUpdate)} containerClassName="flex  items-center text-[#4B4B4B] font-medium rounded-lg border border-[#C7C7C7] py-[7px] px-4 max-w-[161px] w-full">
              <svg
                className="mr-3"
            ...
            <BaseButton buttonText="Cancel" onClick={() => setIsUpdate(!isUpdate)} containerClassName="flex  items-center justify-center text-[#4B4B4B] font-medium rounded-lg border border-[#C7C7C7] py-[7px] px-4 max-w-[161px] w-full">
            </BaseButton>
        }
      </div>
      <Form
