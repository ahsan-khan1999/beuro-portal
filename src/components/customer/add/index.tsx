...
const AddCustomer = () => {
  return (
    <Layout>
      ...
      <div className="flex ">
        <button className="h-fit mr-6 rounded-lg border border-primary bg-white py-[10px] px-4 max-w-[257px] w-full text-lg text-primary font-medium flex items-center">
          <svg
            className="mr-3"
