      ...
      {servicesData?.map((item) => {
        return (
          <div
            ...
            className="cursor-pointer hover:bg-[#E9E1FF] items-center xs:w-fit mlg:w-full xlg:w-auto grid xs:grid-cols-[minmax(100px,_100px)_minmax(200px,_4fr)_minmax(150px,_150px)_minmax(120px,_120px)_minmax(120px,_120px)_minmax(300px,300px)_minmax(90px,_90px)] mlg:grid-cols-[minmax(70px,_70px),minmax(130px,_130px)_minmax(100px,_100px)_minmax(90px,_90px)_minmax(90px,_90px)_minmax(100px,_100%)_minmax(90px,_90px)] xlg:grid-cols-[minmax(80px,_80px),minmax(150px,_4fr)_minmax(150px,_150px)_minmax(100px,_100px)_minmax(100px,_100px)_minmax(150px,_3fr)_minmax(90px,_90px)] border-t border-t-[#E7EAEE]"
          >
