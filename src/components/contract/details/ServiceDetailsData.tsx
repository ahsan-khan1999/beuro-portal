...
const ServiceDetailsData = () => {
  ...
  const serviceDetailsData = [
    {
      productTitle: "2 Mitarbeiter Lorem ipsum dorl",
      description: "Kostenübernahme bei lore Ipsum dollar smith emit em.",
      price: "10000",
      unit: "Std.",
      count: 2,
      totalPrice: "2000CHF",
  ...
  return (
    <LeadsCardLayout>
      <div className="flex justify-between items-center pb-[24px] border-b border-black border-opacity-20">
      ...
      <div className="mt-[23px]">
        <div className="grid grid-cols-[minmax(300px,_100%)_minmax(300px,_100%)_minmax(100px,_100%)_minmax(100px,_100%)_minmax(100px,_100%)_minmax(100px,_100%)]">
          <span className="text-[#8F8F8F] font-medium text-[14px]">
          ...
          <span className="text-[#8F8F8F] font-medium text-[14px]">Unit</span>
          <span className="text-[#8F8F8F] font-medium text-[14px]">Count</span>
          <span className="text-[#8F8F8F] font-medium text-[14px]">
            Total Price
          </span>
        </div>
      ...
      <div className="mt-[28px] ">
        {serviceDetailsData.map((item, index) => (
          <div className=" mb-[18px] grid grid-cols-[minmax(300px,_100%)_minmax(300px,_100%)_minmax(100px,_100%)_minmax(100px,_100%)_minmax(100px,_100%)_minmax(100px,_100%)]">
            <span>{item.productTitle.split(" ").join(" \n")}</span>
      ...
      <div className="float-right px-[26px] py-[12px] mt-5 w-[290px] border border-[#EBEBEB] rounded-lg">
