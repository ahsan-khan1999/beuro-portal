...
const TableRows = ({
  ...
  const handleReceiptPreview = (id?: string) => {
    router.push({
      ...
      query: { ...router.query, tab: "receipt", invoiceID: id, isMail: true },
    });
  };
