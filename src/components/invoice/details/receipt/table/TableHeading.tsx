...
const TableHeading = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="grid grid-cols-[minmax(40px,_40px),_minmax(40px,_40px)] bg-primary py-4 rounded-r-md gap-x-1">
