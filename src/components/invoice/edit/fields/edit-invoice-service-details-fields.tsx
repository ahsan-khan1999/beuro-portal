...
export const EditInvoiceServiceDetailsFormField: GenerateInvoiceServiceFormField =
  (
    register,
    loading,
    control,
            ...
            children: [
...

              {
                field: {
                  ...
                  id: `serviceDetail_${i}`,
                  className:
                    "grid grid-cols-2 xl:grid-cols-3 gap-x-3 gap-y-5 px-2 pt-5 bg-[#EDF4FF]",
                  children: [
                    {
...

              {
                field: {
                  ...
                  id: `serviceDetail_${i}`,
                  className:
                    "grid grid-cols-1 relative w-full space-x-[18px] rounded-b-lg px-2 pt-0 xl:pt-5 pb-5 bg-[#EDF4FF]",
                  children: [
                    {
...
export const EditInvoiceServiceDetailsDescriptionFormField: GenerateInvoiceServiceFormField =
  (
    register,
    loading,
    control,
