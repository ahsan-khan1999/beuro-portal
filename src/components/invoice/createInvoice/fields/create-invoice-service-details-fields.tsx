...
import {
  FormField,
  GenerateInvoiceServiceActionFormField,
  GenerateInvoiceServiceFormField,
} from "@/types";
import {
  Control,
  FieldValues,
...
export const CreateInvoiceServiceDetailsFormField: GenerateInvoiceServiceFormField =
  (
    register,
    loading,
    control,
          ...
          children: [
            {
              field: {
                ...
                id: `div-field`,
                className:
                  "flex justify-between items-center runded-t-lg px-2 pt-3 bg-[#EDF4FF]",
                children: [
                  {
                    field: {
                      type: Field.span,
...

            {
              field: {
                ...
                id: `serviceDetail_${i}`,
                className:
                  "grid grid-cols-2 gap-y-5 xl:gap-y-0 xl:grid-cols-3 gap-x-3 px-2 pt-5 bg-[#EDF4FF]",
                children: [
                  {
...
export const CreateInvoiceServiceDetailsDescriptionFormField: GenerateInvoiceServiceFormField =
  (
    register,
    loading,
    control,
    ...
    const formField: FormField[] = [
      {
        containerClass: "mt-5 bg-white px-5 pt-5 rounded-t-lg",
        //@ts-expect-error
        field: {
          type: Field.div,
          id: "div-field",
...
export const CreateInvoiceDetailsServiceSubmitFormField: GenerateInvoiceServiceActionFormField =
  (loading, OnClick) => {
    const { t: translate } = useTranslation();
    const formField: FormField[] = [
      {
        containerClass: "bg-white rounded-b-lg pt-[55px] pb-5 px-5",
        field: {
          type: Field.div,
          id: "div-field",
