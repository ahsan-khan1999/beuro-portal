    ...
    <div>
      {dataToAdd?.map((item, index: number) => {
        return (
          <div
            key={index}
            className="hover:bg-[#E9E1FF] bg-white px-6 cursor-pointer shadow-tableRow xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(90px,_90px)_minmax(200px,_200px)_minmax(200px,_100%)_minmax(150px,_150px)_minmax(130px,_130px)_minmax(140px,_140px)_minmax(90px,_90px)_minmax(90px,_90px)] mlg:grid-cols-[minmax(80px,_80px)_minmax(130px,_100%)_minmax(110px,_110px)_minmax(120px,_120px)_minmax(120px,_120px)_minmax(80px,_80px)_minmax(80px,_80px)] xlg:grid-cols-[minmax(80px,_80px),minmax(130px,_130px)_minmax(100px,_100%)_minmax(110px,_110px)_minmax(120px,_120px)_minmax(130px,_130px)_minmax(80px,_80px)_minmax(80px,_80px)] maxSize:grid-cols-[minmax(90px,_90px),minmax(100px,_100%)_minmax(150px,_100%)_minmax(130px,_130px)_minmax(130px,_130px)_minmax(140px,_140px)_minmax(90px,_90px)_minmax(80px,_80px)] mt-2 rounded-md"
          >
            <span className="py-4 flex items-center">{item.invoiceNumber}</span>
            <span className="py-4 flex items-center mlg:hidden xlg:flex mr-1 break-all">
              {item.contractID?.offerID?.leadID?.customerDetail?.fullName}
            </span>
            <span className="break-all py-4 flex items-center mr-1">
            {item?.title}
            </span>
