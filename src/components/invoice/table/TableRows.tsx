    ...
    <div>
      {dataToAdd?.map((item, index: number) => {
        return (
          <div
            key={index}
            className="hover:bg-[#E9E1FF] items-center bg-white px-6 cursor-pointer shadow-tableRow xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(90px,_90px)_minmax(200px,_4fr)_minmax(250px,_3fr)_minmax(150px,_150px)_minmax(130px,_130px)_minmax(140px,_140px)_minmax(90px,_90px)_minmax(90px,_90px)] mlg:grid-cols-[minmax(80px,_80px)_minmax(130px,_100%)_minmax(110px,_110px)_minmax(120px,_120px)_minmax(120px,_120px)_minmax(80px,_80px)_minmax(90px,_90px)] xlg:grid-cols-[minmax(80px,_80px),minmax(130px,_130px)_minmax(120px,_100%)_minmax(110px,_110px)_minmax(120px,_120px)_minmax(130px,_130px)_minmax(80px,_80px)_minmax(90px,_90px)] maxSize:grid-cols-[minmax(80px,_80px),minmax(100px,_5fr)_minmax(150px,_4fr)_minmax(130px,_130px)_minmax(130px,_130px)_minmax(140px,_140px)_minmax(90px,_90px)_minmax(90px,_90px)] mt-2 rounded-md"
          >
