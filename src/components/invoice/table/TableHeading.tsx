...
const TableHeading = () => {
  ...
  return (
    <div className="xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(90px,_90px)_minmax(200px,_200px)_minmax(200px,_100%)_minmax(150px,_150px)_minmax(130px,_130px)_minmax(140px,_140px)_minmax(90px,_90px)_minmax(50px,_50px)] mlg:grid-cols-[minmax(80px,_80px)_minmax(130px,_100%)_minmax(110px,_110px)_minmax(110px,_110px)_minmax(120px,_120px)_minmax(70px,_70px)_minmax(50px,_50px)] xlg:grid-cols-[minmax(80px,_80px),minmax(110px,_110px)_minmax(130px,_100%)_minmax(110px,_110px)_minmax(100px,_100px)_minmax(120px,_120px)_minmax(70px,_70px)_minmax(50px,_50px)] maxSize:grid-cols-[minmax(90px,_90px),minmax(100px,_100%)_minmax(150px,_100%)_minmax(130px,_130px)_minmax(100px,_100px)_minmax(200px,_200px)_minmax(70px,_70px)_minmax(50px,_50px)] bg-white rounded-md px-6 pt-[23px] pb-[17px]">
