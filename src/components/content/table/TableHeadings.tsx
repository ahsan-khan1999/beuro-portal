...
const TableHeadings = () => {
  ...
  return (
    <div className="xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(100px,_100px)_minmax(300px,_4fr)_minmax(350px,_3fr)_minmax(150px,_150px)_minmax(90px,_90px)] mlg:grid-cols-[minmax(80px,_80px),minmax(200px,_4fr)_minmax(180px,_3fr)_minmax(200px,_200px)_minmax(90px,_90px)] bg-white rounded-md px-6 pt-[23px] pb-[17px] ">
