...
const TableHeadings = () => {
  ...
  return (
    <div className="xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(100px,_100px)_minmax(200px,_200px)_minmax(250px,_100%)_minmax(150px,_150px)_minmax(70px,_70px)] mlg:grid-cols-[minmax(80px,_80px),minmax(250px,_250px)_minmax(180px,_100%)_minmax(200px,_200px)_minmax(60px,_60px)] bg-white rounded-md px-5 pt-[23px] pb-[17px] ">
