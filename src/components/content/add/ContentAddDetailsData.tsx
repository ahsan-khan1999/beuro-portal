...
const ContentAddDetailsData = () => {
  ...
  useEffect(() => {
    setTabType(contentDetails?.id && contentDetails?.stage || ComponentsType.addOffer)
  }, [contentDetails?.id])
  ...
  const tabSection: tabArrayTypes[] = [
    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 21 22" fill=${tabType === 0 ? "#4A13E7" : "#393939"
        }>
    ...
    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="19" viewBox="0 0 15 19" fill=${tabType === 2 ? "#4A13E7" : "#393939"
        }>
    ...
    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill=${tabType === 3 ? "#4A13E7" : "#1E1E1E"
        }>
