...
const ContentDetails = () => {
  ...
  return (
    <Layout>
      <div className="bg-white rounded-md px-5 pt-5 pb-10 maxSize:fixed maxSize:-mt-[210px] maxSize:border-t-[14px] border-t-defaultBackground contentCalWidth z-10">
        <ContentCard
