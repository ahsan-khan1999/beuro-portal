...
import LeadContentDetails from "./LeadContentDetails";
import EditLeadContentDetails from "../edit/EditLeadContentDetails";
...
const ContentDetailsData = () => {
  ...
  const tabSection: tabArrayTypes[] = [
    ...
    >
      ...
      name: `${translate("content.tabs_headings.lead_content")}`,
    },
    {
...
export default ContentDetailsData;
