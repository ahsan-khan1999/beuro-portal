...
export default function PlanInfo({
  ...
  return (
    <div className="grid xl:grid-cols-3 xl:gap-x-5 xl:gap-y-0 gap-y-8 mt-8">
      {Array.isArray(plan) &&
        plan?.toReversed()?.map((item, index) => {
          return (
            <div
              key={index}
                    ...
                    <div key={index} className="flex items-center space-x-4">
                      ...
                      <li className="text-dark text-xs group-hover:text-white">
                        {item?.numberOfEmployees +
                          ` ${translate("pricing_details.packages.employees")}`}
                      </li>
                    </div>
                    <div key={index} className="flex items-center space-x-4">
                      {item?.accountingReport ? (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="13"
                          height="13"
                        ...
                        >
                          <path
                            className="fill-[#393939] group-hover:fill-white"
                            d="M12.0714 6.52496C12.0714 9.64102 9.54532 12.1671 6.42925 12.1671C3.31318 12.1671 0.787109 9.64102 0.787109 6.52496C0.787109 3.40889 3.31318 0.882812 6.42925 0.882812C9.54532 0.882812 12.0714 3.40889 12.0714 6.52496Z"
                          />
                          <path
                            className="group-hover:fill-primary fill-white"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M8.63766 4.31685C8.80051 4.47971 8.80051 4.74376 8.63766 4.90662L4.81122 8.73306C4.64836 8.89592 4.38431 8.89592 4.22145 8.73306C4.05859 8.5702 4.05859 8.30615 4.22145 8.14329L8.04789 4.31685C8.21075 4.154 8.4748 4.154 8.63766 4.31685Z"
                          />
                          <path
                            className="group-hover:fill-primary fill-white"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M8.63773 8.73287C8.47488 8.89573 8.21083 8.89573 8.04797 8.73287L4.22153 4.90643C4.05867 4.74357 4.05867 4.47953 4.22153 4.31667C4.38439 4.15381 4.64844 4.15381 4.8113 4.31667L8.63773 8.14311C8.80059 8.30596 8.80059 8.57001 8.63773 8.73287Z"
                          />
                        </svg>
                      )}
                      <li className="text-dark text-xs group-hover:text-white">
                        {` ${translate("pricing_details.packages.accounting")}`}
                      </li>
                    </div>
                    <div key={index} className="flex items-center space-x-4">
                      {item?.customizedEmail ? (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="13"
                          height="13"
                      ...
                      <li className="text-dark text-xs group-hover:text-white">
                        {` ${translate("pricing_details.packages.customized")}`}
                      </li>
                    </div>
                    <div key={index} className="flex items-center space-x-4">
                      {item?.watermark ? (
                      ...
                      <li className="text-dark text-xs group-hover:text-white">
                        {` ${translate("pricing_details.packages.watermark")}`}
                      </li>
                    </div>
                    <div key={index} className="flex items-center space-x-4">
                      {item?.apiFeatures ? (
                      ...
                      <li className="text-dark text-xs group-hover:text-white">
                        {` ${translate("pricing_details.packages.features")}`}
                      </li>
                    </div>
                  </ul>
                  <Button
                    inputType="button"
                    text={translate("pricing_details.button")}
                    className="border border-primary bg-white min-w-full  text-primary hover:bg-none mt-6"
                    id="button"
                    loading={loading}
