...
const TableHeadings = () => {
  ...
  return (
    <div className="xs:w-fit xlg:w-auto  mlg:w-full grid xs:grid-cols-[minmax(100px,_100px)_minmax(150px,_150px)_minmax(200px,_100%)_minmax(160px,_160px)_minmax(150px,_150px)_minmax(150px,_150px)_minmax(60px,_60px)] mlg:grid-cols-[minmax(80px,_80px),minmax(120px,_120px)_minmax(160px,_100%)_minmax(130px,_130px)_minmax(120px,_120px)_minmax(110px,_110px)_minmax(50px,_50px)] xlg:grid-cols-[minmax(80px,_80px),minmax(150px,_150px)_minmax(170px,_100%)_minmax(150px,_100%)_minmax(120px,_120px)_minmax(130px,_130px)_minmax(50px,_50px)]  bg-white rounded-md px-5 pt-[23px] pb-[17px]">
