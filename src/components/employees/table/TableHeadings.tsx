...
const TableHeadings = () => {
  ...
  return (
    <div className="xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(100px,_100px)_minmax(150px,_150px)_minmax(250px,_100%)_minmax(160px,_160px)_minmax(150px,_150px)_minmax(150px,_150px)_minmax(90px,_90px)] mlg:grid-cols-[minmax(80px,_80px),minmax(110px,_110px)_minmax(100px,_100%)_minmax(130px,_130px)_minmax(120px,_120px)_minmax(110px,_110px)_minmax(80px,_80px)] xlg:grid-cols-[minmax(80px,_80px),minmax(150px,_150px)_minmax(100px,_100%)_minmax(150px,_150px)_minmax(140px,_140px)_minmax(140px,_140px)_minmax(80px,_80px)]  bg-white rounded-md px-6 pt-[23px] pb-[17px]">
