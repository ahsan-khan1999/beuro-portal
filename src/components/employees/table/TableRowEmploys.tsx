    ...
    <div>
      {employsData?.map((item: any) => {
        return (
          <div
            key={item.id}
            className="shadow-tableRow grid grid-cols-[minmax(70px,_70px),minmax(200px,_100%)_minmax(200px,_100%)_minmax(200px,_100%)_minmax(200px,_100%)_minmax(200px,_100%)_minmax(70px,_150px)_minmax(70px,_70px)] mt-2 bg-white rounded-md"
          >
            ...
            <span className="px-6 py-4 bg-white  ">{item.designation}</span>
