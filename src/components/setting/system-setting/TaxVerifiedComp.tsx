          ...
          {toggleBtnsData.map((item, index) => (
            <div
              className={`border rounded-md py-4 px-[18px] flex justify-between items-center w-full cursor-pointer ${
                activeButton === index ? "border-[#4A13E7]" : "border-[#EBEBEB]"
              }`}
              key={index}
            ...
            >
              <span
                className={`text-base font-medium ${
                  activeButton === index ? "text-[#4A13E7]" : "text-[#4B4B4B]"
                }`}
              >
                {item}
              </span>
              <svg
                ...
                height="15"
                viewBox="0 0 15 15"
                fill={activeButton === index ? "#4A13E7" : "#BFBFBF"}
              >
