...
import { ColumnStructure, MainColumns, Template, colsData } from "@/types/settings";
...
const Column = ({
  ...
  title: string;
  data: colsData[];
  handleChange: (column: string, type: string, value: boolean, index: number) => void,
  ...
  return (
    ...
    <section className="px-[30px] pt-[20px] pb-[25px] rounded-md bg-white mb-6">
      <div className="flex justify-between mb-3">
        ...
        <ToggleButton isChecked={mainColumns[column]} onChange={(value) => handleToggle(column, value.target.checked)} />
      </div>
      {data.map((item, index) => (
        <div className="mb-5" key={index}>
          ...
          <div className="border rounded-lg border-[#EBEBEB] p-4 flex justify-between items-center mt-[10px]">
            ...
            <CheckBox isChecked={item.data.value} id={item.data.column + index.toString()} key={index} onChange={(value) => handleChange(item.data.column, item.data.type, value, index)} />
...
const ColumnsComp = () => {
  ...
  const { loading, templateSettings } = useAppSelector(state => state.settings)
      ...
      firstColumn: [
        {
          ...
          data: { column: "firstColumn", type: "isCompanyName", value: templateSettings?.firstColumn?.isCompanyName || false },
        },
        {
          title: `${translate("setting.templates.first_col_heading.email")}`,
          placeholder: "youremail@gmail.com",
          data: { column: "firstColumn", type: "isEmail", value: templateSettings?.firstColumn?.isEmail || false },
        ...
        },
        {
          ...
          data: { column: "firstColumn", type: "isPhoneNumber", value: templateSettings?.firstColumn?.isPhoneNumber || false },
        ...
        },
        {
          ...
          data: { column: "firstColumn", type: "isTaxNumber", value: templateSettings?.firstColumn?.isWebsite || false },
        ...
        },
        {
          ...
          data: { column: "firstColumn", type: "isWebsite", value: templateSettings?.firstColumn?.isTaxNumber || false },
      ...
      secondColumn: [
        {
          ...
          data: { column: "secondColumn", type: "isStreetNumber", value: templateSettings?.secondColumn?.isStreetNumber || false },
        ...
        },
        {
          ...
          placeholder: "00000",
          data: { column: "secondColumn", type: "isPostCode", value: templateSettings?.secondColumn?.isPostCode || false },
        ...
        },
        {
          ...
          placeholder: "ABC",
          data: { column: "secondColumn", type: "isBankName", value: templateSettings?.secondColumn?.isBankName || false },
        ...
        },
        {
          ...
          placeholder: "0000000",
          data: { column: "secondColumn", type: "isAccountNumber", value: templateSettings?.secondColumn?.isAccountNumber || false },
        ...
        },
        {
          ...
          data: { column: "secondColumn", type: "isIBAN", value: templateSettings?.secondColumn?.isIBAN || false },
      ...
      thirdColumn: [
        {
          ...
          placeholder: " ",
          data: { column: "thirdColumn", type: "isRow1", value: templateSettings?.thirdColumn?.isRow1 || false },
        ...
        },
        {
          ...
          placeholder: " ",
          data: { column: "thirdColumn", type: "isRow2", value: templateSettings?.thirdColumn?.isRow2 || false },
        ...
        },
        {
          ...
          placeholder: " ",
          data: { column: "thirdColumn", type: "isRow3", value: templateSettings?.thirdColumn?.isRow3 || false },
        ...
        },
        {
          ...
          placeholder: " ",
          data: { column: "thirdColumn", type: "isRow4", value: templateSettings?.thirdColumn?.isRow4 || false },
        ...
        },
        {
          ...
          placeholder: " ",
          data: { column: "thirdColumn", type: "isRow5", value: templateSettings?.thirdColumn?.isRow5 || false },
      ...
      fourthColumn: [
        {
          title: `${translate("setting.templates.third_column.row_one")}`,
          placeholder: " ",
          data: { column: "fourthColumn", type: "isRow1", value: templateSettings?.fourthColumn?.isRow1 || false },
        ...
        },
        {
          title: `${translate("setting.templates.third_column.row_two")}`,
          placeholder: " ",
          data: { column: "fourthColumn", type: "isRow2", value: templateSettings?.fourthColumn?.isRow2 || false },
        ...
        },
        {
          title: `${translate("setting.templates.third_column.row_three")}`,
          placeholder: " ",
          data: { column: "fourthColumn", type: "isRow3", value: templateSettings?.fourthColumn?.isRow3 || false },
        ...
        },
        {
          title: `${translate("setting.templates.third_column.row_fourth")}`,
          placeholder: " ",
          data: { column: "fourthColumn", type: "isRow4", value: templateSettings?.fourthColumn?.isRow4 || false },
        ...
        },
        {
          title: `${translate("setting.templates.third_column.row_fifth")}`,
          placeholder: " ",
          data: { column: "fourthColumn", type: "isRow5", value: templateSettings?.fourthColumn?.isRow5 || false },
  ...
  useEffect(() => {
    setMainColumns({
      ...mainColumns, firstColumn: templateSettings?.isFirstColumn || false, secondColumn: templateSettings?.isSecondColumn || false
      , thirdColumn: templateSettings?.isThirdColumn || false
      , fourthColumn: templateSettings?.isFourthColumn || false

    })
    updateColumnValues(columnSettings.firstColumn, templateSettings?.firstColumn)
    updateColumnValues(columnSettings.secondColumn, templateSettings?.secondColumn)
    updateColumnValues(columnSettings.thirdColumn, templateSettings?.thirdColumn)
    updateColumnValues(columnSettings.fourthColumn, templateSettings?.fourthColumn)
  }, [templateSettings])

  const handleChange = (column: string, type: string, value: boolean, index: number) => {
