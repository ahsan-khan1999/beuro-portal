...
const TableHeading = () => {
  ...
  return (
    <div className="xs:w-fit xlg:w-auto mlg:w-full grid xs:grid-cols-[minmax(60px,_60px),minmax(80px,_80px)_minmax(200px,_200px)_minmax(160px,_160px)_minmax(300px,_100%)_minmax(140px,_140px)_minmax(120px,_120px)_minmax(50px,_50px)] mlg:grid-cols-[minmax(50px,_50px),minmax(70px,_70px)_minmax(150px,_100%)_minmax(160px,_160px)_minmax(90px,_90px)_minmax(100px,_100px)_minmax(50px,_50px)] xlg:grid-cols-[minmax(50px,_50px),minmax(70px,_70px)_minmax(180px,_180px)_minmax(180px,_180px)_minmax(120px,_100%)_minmax(90px,_90px)_minmax(100px,_100px)_minmax(40px,_40px)] bg-white rounded-md px-5 pt-[23px] pb-[17px] ">
