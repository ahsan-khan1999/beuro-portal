  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row gap-4 justify-between lg:items-center pb-5">
        ...
        <div className="flex items-center gap-x-4">
          <button
            ...
            className="flex items-center rounded-lg border border-primary px-4 py-2 text-[#4B4B4B] font-medium gap-3 w-fit"
          >
            {!isCustomerFree ? (
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="border-t border-t-[#000] border-opacity-10 pt-5">
        <div className="grid gap-x-5 grid-cols-2 xLarge:grid-cols-[minmax(150px,_100%)_minmax(150px,_100%)_minmax(250px,_100%)_minmax(150px,_100%)_minmax(250px,_100%)] gap-y-2">
          ...
          <div className="flex items-center gap-x-3">
            ...
            <span className="text-[#4B4B4B] font-medium">
              {customerDetail?.plan?.planName !== undefined &&
