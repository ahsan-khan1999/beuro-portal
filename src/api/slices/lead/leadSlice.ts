...
export const updateLeadStatus: AsyncThunk<boolean, object, object> | any =
  createAsyncThunk("lead/update/status", async (args, thunkApi) => {
    const { data, router, setError, translate } = args as any;
...
const leadSlice = createSlice({
  ...
  extraReducers(builder) {
    ...
    builder.addCase(updateLead.fulfilled, (state, action) => {
      let index = state.lead.findIndex(
